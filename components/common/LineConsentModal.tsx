        ...
        >
          ...
          >
            ...
            <div className="flex flex-col space-y-4">
              ...
              <Button onClick={onClose} variant="outline" className="w-full py-3 border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 font-semibold rounded-lg">
                キャンセル
              </Button>
            </div>
          </motion.div>
