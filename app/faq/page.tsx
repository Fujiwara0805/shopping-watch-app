    ...
    questions: [
      {
        question: 'TALEとは何ですか？',
        answer:
          'TALEは、各地域のイベント、お祭り、マルシェの情報を地図上で検索できる完全無料のイベント発見プラットフォームです。お祭り、マルシェ、ワークショップなどの地域密着型イベントをリアルタイムで発見できます。位置情報を活用することで、現在地周辺のイベントを簡単に見つけることができます。',
      },
      {
        question: '以前の「トクドク」とは何ですか？TALEと同じサービスですか？',
        answer:
          'はい、同じサービスです。「トクドク」は2026年に「TALE（テイル）」へ名称変更しました。URL（tokudoku.com）や機能、これまでの投稿データはそのまま引き継がれているため、これまで通りご利用いただけます。',
      },
      {
        question: 'TALEの利用料金はいくらですか？',
        answer:
          'TALEは完全無料でご利用いただけます。アカウント登録も不要で、今すぐイベント検索を始められます。すべての機能を無料でお使いいただけます。',
      },
      {
        question: 'どのようなイベント情報が掲載されていますか？',
        answer:
          'TALEでは、各地域のお祭り、夏祭り、秋祭り、地域のマルシェ、手作り市、ワークショップ、体験イベント、フードフェスティバル、音楽イベントなど、さまざまな地域密着型イベント情報を掲載しています。終了したイベントは自動的に非表示になるため、常に最新の情報をご覧いただけます。',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          'TALEでは地図上にイベント情報がマーカーで表示されます。マップを移動・拡大縮小して、気になるエリアのイベントを探すことができます。位置情報を許可すると、現在地周辺のイベントが自動的に表示されます。マーカーをタップすると、イベントの詳細情報を確認できます。',
      },
      {
      ...
      },
      {
        ...
        answer:
          'はい、TALEはスマートフォン、タブレット、パソコンなど、あらゆるデバイスでご利用いただけます。ウェブブラウザから簡単にアクセスでき、アプリのインストールは不要です。レスポンシブデザインにより、どのデバイスでも快適にご利用いただけます。',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          'はい。TALEは各地域のイベント、お祭り、マルシェの情報に対応しています。現在は大分県の情報が特に充実していますが、対応エリアを順次拡大しています。お住まいの地域のイベントもぜひ投稿・チェックしてください。',
      },
      {
        question: 'イベント情報の更新頻度は？',
        answer:
          'TALEのイベント情報はリアルタイムで更新されます。終了したイベントは自動的に表示されなくなり、新しいイベントが随時追加されます。常に最新のイベント情報をご覧いただけます。',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'はい、TALEではユーザーのプライバシー保護を最優先に考えています。位置情報はイベント検索のみに使用され、第三者に共有されることはありません。詳細はプライバシーポリシーをご確認ください。',
      },
    ],
  },
];
