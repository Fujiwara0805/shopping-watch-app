...
export const metadata: Metadata = {
  ...
  keywords: '大分 イベント,大分 イベント 今日,大分県 イベント,大分市 イベント,別府市 イベント,中津市 イベント,日田市 イベント,由布市 イベント,大分 お祭り,大分 マルシェ,大分 今週末,イベント一覧,秋祭り,夏祭り,ワークショップ,体験イベント,手作り市,フードフェス,音楽イベント,地域イベント,週末 予定,明日 イベント,TALE,トクドク',
  openGraph: {
    title: '大分のイベント情報【今日・今週末】お祭り・マルシェ一覧 | TALE',
