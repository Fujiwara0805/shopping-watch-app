...
const announcements: Announcement[] = [
  {
    ...
    date: '2026.06.29',
    category: 'update',
    title: 'サービス名を「トクドク」から「TALE」へ変更しました。',
    content: 'これまで「トクドク」としてご提供してきたサービスは、「TALE（テイル）」へ名称を変更しました。地域に眠る物語（Tale）を、地図の上で見つけて巡っていく——そんな想いを込めた新しい名前です。URL（tokudoku.com）やこれまでの機能・投稿データはそのまま引き継がれ、変わらずご利用いただけます。今後は大分県をはじめ、各地域のイベント、お祭り、マルシェの情報に対応エリアを広げていきます。',
  },
  {
    id: '1',
    date: '2026.03.06',
    category: 'update',
    title: 'TALE（旧トクドク）がリニューアルしました！イベント検索がより便利に。',
    content: 'TALE（旧トクドク）が大幅リニューアル。地域のイベント・祭り・マルシェ情報を地図から簡単に探せるようになりました。登録不要で、すぐにご利用いただけます。',
  },
  {
    id: '2',
    date: '2026.03.01',
    category: 'info',
    title: '地域のイベント情報を随時更新中です。',
    content: '大分県18市町村をはじめ、各地のイベント・祭り・マルシェの情報を随時更新しています。最新の情報は地図画面からご確認ください。',
  },
  {
    id: '3',
    date: '2026.02.20',
    category: 'info',
    title: 'サービスを開始しました。',
    content: '地域のイベント情報を一括検索できるサービス「TALE（旧トクドク）」をリリースしました。地図上でイベントの場所を確認でき、詳細情報もワンタップで確認できます。',
  },
];
