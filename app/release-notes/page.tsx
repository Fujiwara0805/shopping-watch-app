    ...
    changes: [
      {
        type: 'new',
        title: 'ジャンル機能の追加',
        description: 'ショッピング、飲食店、観光、レジャー、サービス、その他の6つのジャンルを追加。投稿をより詳細に分類できるようになり、ユーザーが求める情報を見つけやすくなりました。'
      },
      {
        type: 'new',
        title: '複数画像投稿機能',
      ...
      },
      {
        ...
        description: '基本情報にジャンル行を追加し、場所・ジャンル・カテゴリーの順で表示。ジャンル専用アイコン（ショッピング：カート、飲食店：食器、観光：カメラなど）を採用し、視覚的に分かりやすくなりました。'
      },
      {
        type: 'improvement',
        title: 'カテゴリー分類の大幅拡張',
        description: 'ジャンルに応じたカテゴリー分類を実装。ショッピング系11種類、飲食店系8種類、観光系6種類、レジャー系5種類、サービス系5種類の詳細なカテゴリーで、より正確な情報分類が可能になりました。'
      },
      {
        type: 'improvement',
        title: '5km圏内投稿表示の最適化',
